    ...
    void SetLevelParameters()
    {
        ...
        if (!victory)
        {
          ...
          */
            ...
            numEnemiesToSpawn = Mathf.CeilToInt(densityModifer/2f * (width / levelScale + currentLevel / Mathf.Max((densityModifer * UnityEngine.Random.Range(1, densityModifer + currentLevel)), 1)) / 3);
            bossRound = false;
